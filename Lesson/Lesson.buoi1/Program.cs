...
class Program
{
    static void Main(string[] args)
    {
        ...
        // viet 1 ham tinh tong cac so chan va tong so luong cac so chan
        // tu 1 -> n
        // va khong dung return
        static void Nene(int n, out int sum, out int count)
        {
            sum = 0;
            count = 0;
            for (int i = 0; i <= n; i++)
        ...
        Nene(10, out int ha, out int count);
        Console.WriteLine("sum ne = " + ha + ", count = " + count);
    }
}